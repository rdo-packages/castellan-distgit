...
%changelog
* Wed Dec 02 2020 RDO <dev@lists.rdoproject.org> 1.3.4-1
- Update to 1.3.4

* Tue Jul 21 2020 RDO <dev@lists.rdoproject.org> 1.3.3-1
- Update to 1.3.3

* Mon May 11 2020 RDO <dev@lists.rdoproject.org> 1.3.2-1
- Update to 1.3.2

* Wed Oct 02 2019 Joel Capitao <jcapitao@redhat.com> 1.3.1-2
- Removed python2 subpackages in no el7 distros

* Thu Sep 19 2019 RDO <dev@lists.rdoproject.org> 1.3.1-1
- Update to 1.3.1
